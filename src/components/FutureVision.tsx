...
const FutureVision = () => {
  return <section id="futuro" className="section-padding bg-gradient-to-b from-background to-secondary">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-16">
          {futureFeatures.map((feature, index) => <div key={index} className="glass p-6 h-full flex flex-col animate-fade-up" style={{
        ...
        <div className="text-center">
          ...
          <Button size="lg" className="bg-success hover:bg-success/90 px-0">
