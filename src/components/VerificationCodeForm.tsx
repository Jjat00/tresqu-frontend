...
const VerificationCodeForm = ({
  ...
  const handleVerifyCode = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error("Error al verificar el código. Por favor, inténtalo de nuevo.");
    } finally {
  ...
  return <div className="space-y-4">
      ...
      <form onSubmit={handleVerifyCode} className="space-y-6">
        <div className="flex justify-center py-[13px] px-0 mx-px">
          <InputOTP maxLength={6} value={verificationCode} onChange={setVerificationCode} className="gap-2">
            <InputOTPGroup>
        ...
        <div className="flex gap-3">
          ...
          <Button type="submit" className="flex-1 bg-[#0088cc] hover:bg-[#0088cc]/90 text-white" disabled={isSubmitting || verificationCode.length !== 6}>
