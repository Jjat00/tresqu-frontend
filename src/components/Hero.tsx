...
const Hero = () => {
  return <section className="relative overflow-hidden py-12 md:py-24 lg:py-32">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-6 md:space-y-10 text-center">
          <div className="space-y-4 md:space-y-6 max-w-4xl">
            ...
            <p className="text-base md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto animate-fade-in" style={{
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md animate-fade-in" style={{
          animationDelay: "200ms"
        }}>
            <Button className="bg-success hover:bg-success/90 text-base md:text-lg w-full px-4 md:px-8 py-5 md:py-6" asChild size="lg">
              <Link to="/dashboard">
          ...
          <div className="w-full max-w-sm mx-auto mt-4 md:mt-8 animate-fade-in" style={{
