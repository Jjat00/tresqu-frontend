...
const DebtTab = () => {
  ...
  const simulationResults = useMemo(() => {
    ...
    if (simulatorValues.debtAmount > 0 && simulatorValues.monthlyPayment > 0) {
      const totalPayment =
        simulatorValues.monthlyPayment + simulatorValues.extraPayment;
        ...
        <div className="flex items-center gap-2">
          <Select value={timeFilter} onValueChange={setTimeFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="high-interest">
        ...
        <Dialog open={newDebtOpen} onOpenChange={setNewDebtOpen}>
          ...
          <DialogContent className="max-h-[90vh] overflow-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Ingresa los detalles de tu deuda para empezar a hacer
                seguimiento
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <label htmlFor="remainingAmount" className="text-right text-sm">
                  Saldo actual
                </label>
                <Input
                  id="remainingAmount"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <label htmlFor="monthlyPayment" className="text-right text-sm">
                  Pago mensual
                </label>
                <Input
                  id="monthlyPayment"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <label htmlFor="nextPaymentDate" className="text-right text-sm">
                  Próximo pago
                </label>
                <Input
                  id="nextPaymentDate"
            ...
            <DialogFooter>
              <Button variant="outline" onClick={() => setNewDebtOpen(false)}>
                Cancelar
              </Button>
          ...
          <CardContent className="pt-6">
              ...
              <Dialog open={simulatorOpen} onOpenChange={setSimulatorOpen}>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Calcula cuánto tiempo tardarás en pagar tu deuda y cuánto
                      ahorrarás aumentando tus pagos
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4 py-4">
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">
                          ${simulatorValues.debtAmount.toLocaleString()}
                        </span>
                      </div>
                      <Slider
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">
                          ${simulatorValues.monthlyPayment.toLocaleString()}
                        </span>
                      </div>
                      <Slider
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-success">
                          +${simulatorValues.extraPayment.toLocaleString()}
                        </span>
                      </div>
                      <Slider
                      ...
                      <div className="grid grid-cols-2 gap-y-4 mt-4">
                        <div>
                          ...
                          <p className="font-semibold">
                            ...
                            {Math.floor(simulationResults.monthsToPayoff / 12)}{" "}
                            años
                            {simulationResults.monthsToPayoff % 12 > 0
                              ? ` ${
                                  simulationResults.monthsToPayoff % 12
                                } meses`
                              : ""}
                            )
                          </p>
                        ...
                        <div>
                          ...
                          <p className="font-semibold">
                            ${simulationResults.totalInterest.toLocaleString()}
                          </p>
                        </div>
                        <div className="col-span-2">
                          ...
                          <p className="font-semibold">
                            ${simulationResults.totalPaid.toLocaleString()}
                          </p>
                        </div>
                      </div>
                      ...
                      {simulatorValues.extraPayment > 0 && (
                        <div className="mt-4 p-2 rounded bg-success/10 text-sm">
                          <p className="text-success font-semibold">
                            ...
                            {Math.round(
                              simulatorValues.debtAmount *
                                (1 + simulatorValues.interestRate / 100) -
                                simulationResults.totalPaid
                            ).toLocaleString()}
                            !
                          </p>
                        </div>
            ...
            <div className="bg-muted/50 p-4 rounded-lg">
              <p className="text-sm mb-4">
                ¿Qué pasaría si aumentas tu pago mensual? Prueba nuestro
                simulador para ver cómo afectaría tu deuda.
              </p>
