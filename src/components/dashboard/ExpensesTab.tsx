...
const ExpensesTab = ({ selectedMonth = "Abril" }: ExpensesTabProps) => {
  ...
  return (
    <div className="space-y-3 md:space-y-6 px-1 sm:px-2 md:px-4 flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 h-[320px] xs:h-[380px] sm:h-[420px]">
