      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        ...
        <Dialog open={newGoalOpen} onOpenChange={setNewGoalOpen}>
          ...
          <DialogContent>
            ...
            <DialogFooter>
              <Button variant="outline" onClick={() => setNewGoalOpen(false)}>Cancelar</Button>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-muted/30 p-4 rounded-lg">
              <p className="text-sm text-muted-foreground">Meta mensual sugerida</p>
                  ...
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Meta: ${goal.target.toLocaleString()} | Fecha: {new Date(goal.deadline).toLocaleDateString()}
                      </p>
                    </div>
              ...
              <div className="border rounded-lg p-4 bg-muted/30">
                ...
                <ul className="space-y-2 pl-5 list-disc">
                  <li className="text-sm">
                    Reducir gastos en <span className="font-medium">Entretenimiento</span> podría ahorrarte <span className="text-success font-medium">$800/mes</span>
                  </li>
                  <li className="text-sm">
                    Has gastado un 30% más en <span className="font-medium">Restaurantes</span> este mes
                  </li>
                  <li className="text-sm">
                    Ideal para ahorrar: <span className="text-highlight font-medium">15-20%</span> de tus ingresos mensuales
                  </li>
                </ul>
              </div>
              
              <div className="border rounded-lg p-4 bg-success/10">
                <h4 className="font-semibold mb-2">Plan automático de ahorro</h4>
                <p className="text-sm mb-2">
                  Basado en tus ingresos y gastos, te sugerimos ahorrar:
                </p>
                <div className="bg-card p-3 rounded-lg mb-4">
                  <span className="text-xl font-bold text-success">$3,200 mensuales</span>
                </div>
