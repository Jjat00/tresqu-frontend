...
const HowItWorks = () => {
  return <section id="como-funciona" className="section-padding bg-secondary">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {steps.map((step, index) => <div key={index} className="relative">
            ...
            animationDelay: `${index * 100}ms`
          }} className="glass p-6 h-full flex flex-col items-center text-center animate-fade-up my-0">
                ...
                {index < steps.length - 1 && <div className="hidden md:block absolute top-1/3 -right-4 transform translate-x-1/2">
                    <div className="w-8 h-8 rounded-full bg-success/20 flex items-center justify-center">
                      <ArrowRight className="h-4 w-4" />
                    </div>
                  </div>}
              </div>
              {index + 1 < steps.length && <div className="md:hidden flex justify-center my-4">
