...
const testimonials = [
  {
    ...
    description:
      "Busco una forma sencilla de anotar mis gastos mientras estoy en movimiento sin tener que abrir aplicaciones complicadas.",
    location: "Madrid",
    price: "Gratis",
    time: "Uso diario",
  },
  {
    ...
    description:
      "Necesitamos una solución simple para que nuestro equipo registre gastos de trabajo sin complicaciones.",
    location: "Remoto",
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          <div className="lg:w-1/2">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              <span className="text-success">Registra tus gastos</span> con la
              simplicidad de un mensaje
            </h1>
            <p className="text-muted-foreground text-lg mb-8">
              La plataforma donde personas, empresas y profesionales manejan sus
              finanzas de forma conversacional, sin aplicaciones complicadas.
            </p>
