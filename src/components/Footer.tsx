          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed max-w-sm mb-6">
                Tu asistente financiero que vive en WhatsApp y Telegram.
              ...
              <div className="flex items-center gap-3">
                {socialLinks.map((link, index) => (
                  <a
                    ...
                    className="w-10 h-10 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-500 hover:text-[#00FF7F] hover:border-[#00FF7F]/30 transition-all duration-300"
                  >
                    {link.icon}
                  </a>
                ))}
