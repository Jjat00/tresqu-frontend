    ...
    <div className="min-h-screen bg-background flex flex-col">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/" className="flex items-center gap-2">
              <span className="text-xl font-bold font-display text-success">
                Cash<span className="text-foreground">Bot</span>
              </span>
            </Link>
          </div>
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6 lg:p-8 overflow-auto pt-6 pb-16">
          <div className="container max-w-6xl py-0 mx-0 px-px">{children}</div>
        </main>
      </div>
      ...
      <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Personaliza tus preferencias de idioma, zona horaria y
              notificaciones.
            </DialogDescription>
          </DialogHeader>
