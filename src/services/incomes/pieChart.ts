import { DonutChartData, DonutChartParams } from "../../types/incomes";
import { apiClient } from "../api";
import { getUserTimezone } from "@/utils/dateUtils";

/**
 * Servicio para obtener datos de ingresos formateados para gráficas de dona
 */
export class PieChartService {
  ...
  /**
   * Obtiene los datos para la gráfica de dona de ingresos
   *
  ...
  async getDonutChartData(
    ...
    const endpoint = `${this.baseUrl}/incomes/donut_chart_data/`;
    ...
    try {
      ...
      console.error(
        "Error al obtener datos para la gráfica de dona de ingresos:",
        error
      );
      throw error;
    }
